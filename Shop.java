...
public class Shop {
	...
	public Shop(String items_file, String orders_file) throws Exception{    	
        TreeMap <String, ArrayList<String>> orders = new TreeMap<>();        
...
//			items.put(items_scanner.next(),Integer.parseInt(items_scanner.next().substring(1)));
    ...
    public static void addItem(TreeMap <String,ArrayList<String>>store, String name, String item){
    	System.out.println("-----------------------------------------------------");
    ...
    public static void deleteItem(TreeMap <String,ArrayList<String>>store, String name, String item) {
    	System.out.println("-----------------------------------------------------");
    ...
    public static void cart(TreeMap <String,ArrayList<String>>store, TreeMap<String, Integer> items, String name) {
    	System.out.println("-----------------------------------------------------");
    ...
    public static void checkout(TreeMap <String,ArrayList<String>>store, TreeMap<String, Integer> items, String name){
    	System.out.println("-----------------------------------------------------");
        ArrayList<String> tempCart = store.get(name);
        Integer totalCost = 0;
